...
class ParserModel(nn.Module):
	...
	def __init__(self, embeddings, n_features=36,
		...
		self.embeddings = nn.Parameter(torch.tensor(embeddings))		# 这里相当于是把预训练好embeddings当作模型参数继续训练 
		...
		# 直接使用nn.Linear的接口(不作实现)
		# self.embed_to_hidden_weight对应self.embed_to_hidden.weight
		# self.embed_to_hidden_bias对应self.embed_to_hidden.bias
		...
		# 直接使用nn.Linear的接口(不作实现)
		# self.hidden_to_logits_weight对应self.hidden_to_logits.weight
		# self.hidden_to_logits_bias对应self.hidden_to_logits.bias		
